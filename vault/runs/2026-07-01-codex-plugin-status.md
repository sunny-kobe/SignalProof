...
- `~/.codex/config.toml` 中启用项：9 个。
- `codex plugin list` 中已安装启用的 marketplace 插件：8 个。
- `codex plugin list` 中未安装的 marketplace 插件：182 个。
- primary-runtime 配置启用项：5 个。
- primary-runtime 本机缓存可用能力：5 个，通常包括 Documents / PDF / Spreadsheets / Presentations。
...
| 名称 | 路径 |
| --- | --- |
| `openai-primary-runtime` | `/Users/rust/.cache/codex-runtimes/codex-primary-runtime/plugins/openai-primary-runtime` |
